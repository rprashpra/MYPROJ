<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CARD.aspx.cs" Inherits="FRANCHISEPORT_1.CARDaspx" %>
...
<body style="background-color:gainsboro">
    ...
    <section class="container-fluid" style="width:50%;background-color:lightblue">
      <div class="row">
          <div class="col-lg-12">
              <h1 class="text-center w3-animate-fading w3-anmate-right" style="background-color:royalblue;opacity:8;font-family:'Buxton Sketch';font-size:xx-large;font-weight:bolder;color:black;border:solid thick ridge"><strong><u style="text-underline-position:below">CARD DETAILS</u></strong></h1>
              <hr />
              <div class="form-group">
              <asp:Label ID="Label1" runat="server" Text="CARDNO:" style="font-family:Arial;font-weight:bolder"></asp:Label>
              <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="TextCARDNO" ForeColor="Red"></asp:RequiredFieldValidator>
              <asp:TextBox ID="TextCARDNO" CssClass="form-control-sm" TextMode="Number" placeholder="xxxxx"  style="width:25%;margin-left:4.5%" runat="server"></asp:TextBox>
                  <asp:TextBox ID="TextDATE"  CssClass="form-control-sm" TextMode="Date" runat="server"></asp:TextBox>
               </div>
              <div class="form-group">
               <asp:Label ID="Label2" runat="server" Text="HOLDERNAME:" style="font-family:Arial;font-weight:bolder"></asp:Label>
              <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ControlToValidate="TextHOLDERNAME" ForeColor="Red"></asp:RequiredFieldValidator>
              <asp:TextBox ID="TextHOLDERNAME" CssClass="form-control-sm" placeholder="xxxxx"  style="width:25%;margin-left:-1%" runat="server"></asp:TextBox>
              </div>
              <div class="form-group">
               <asp:Label ID="Label3" runat="server" Text="ISSUEINGBANK:" style="font-family:Arial;font-weight:bolder"></asp:Label>
                  <asp:DropDownList ID="DropDownList1"  style="width:25%;margin-left:-0.8%" runat="server" DataSourceID="SqlDataSource2" DataTextField="BankName" DataValueField="BankName" ></asp:DropDownList>
                  
                  <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="Data Source=cif5;Initial Catalog=CiftLab;User ID=sa;Password=2011_sa" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [BankName] FROM [tblclPayments]"></asp:SqlDataSource>
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server"></asp:SqlDataSource>
                  
              </div>
              <div class="form-group">
               <asp:Label ID="Label4" runat="server" Text="APPROVALNO:" style="font-family:Arial;font-weight:bolder"></asp:Label>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ControlToValidate="TextAPPROVALNO" ForeColor="Red"></asp:RequiredFieldValidator>
                  <asp:TextBox ID="TextAPPROVALNO" TextMode="Number" placeholder="xxxxx"  style="width:25%;margin-left:-1%" runat="server"></asp:TextBox>
              </div>
                   <hr />
                  <div class="clearfix">
                  <center><asp:Button ID="Btn_OK" runat="server" Text="OK" OnClick="Btn_OK_Click" /></center>
