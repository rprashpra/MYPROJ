<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CHEQUE.aspx.cs" Inherits="FRANCHISEPORT_1.CHEQUE" %>
...
<body style="background-color:gainsboro">
    ...
    <section class="container-fluid" style="width:50%;background-color:lightblue">
       <div class="row">
           <div class="col-lg-12">
               <h1 class="text-center w3-animate-fading w3-anmate-right" style="background-color:royalblue;opacity:8;font-family:'Buxton Sketch';font-size:xx-large;font-weight:bolder;color:white;border:solid thick ridge"><strong><u style="text-underline-position:below">CHEQUE DETAILS</u></strong></h1>
              <hr />
